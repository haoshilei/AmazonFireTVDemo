...
/**
 * A list adapter for a list of {@link com.sample.tom.asbuilibrary.list.CoverItemPagingCarouselView}
 */
public class CarouselListAdapter extends BaseAdapter implements com.sample.tom.asbuilibrary.list.adapter.CarouselListAdapterProvider
{
